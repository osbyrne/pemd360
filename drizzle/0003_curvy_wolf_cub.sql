...
ALTER TABLE `cerfa_diagnostiqueur` ALTER COLUMN "cp" TO "cp" text(5);--> statement-breakpoint
...
ALTER TABLE `cerfa_mtr_ouvrage` ALTER COLUMN "cp" TO "cp" text(5);--> statement-breakpoint
ALTER TABLE `cerfa_operation` ALTER COLUMN "cp" TO "cp" text(5);--> statement-breakpoint
ALTER TABLE `projet` ALTER COLUMN "cp" TO "cp" text(5) NOT NULL;--> statement-breakpoint
ALTER TABLE `user` ALTER COLUMN "banned" TO "banned" integer DEFAULT 0;