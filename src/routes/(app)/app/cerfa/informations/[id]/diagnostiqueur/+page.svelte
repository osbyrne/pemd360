...
<div class="mx-auto max-w-2xl p-6">
  ...
  <div class="card bg-base-100 shadow-sm">
    <div class="px-6 py-4">
      <h1 class="text-xl font-semibold">Le diagnostiqueur</h1>
    </div>
    <div class="p-6">
      <form method="POST" use:enhance class="space-y-6">
        ...
        <div class="space-y-4 border-t border-gray-200 pt-6">
          ...
          <label for="engagementAssurance" class="flex cursor-pointer items-start gap-3">
            <input
          ...
          <div>
            <label for="nomAssurance" class="mb-2 block text-sm font-medium"
          ...
          <div>
            <label for="numeroPolice" class="mb-2 block text-sm font-medium">Numéro de police</label
            >
            <input
              id="numeroPolice"
              name="numeroPolice"
          ...
          <div>
            <label class="mb-2 block text-sm font-medium">Date de validité</label>
            <div class="grid grid-cols-2 gap-4">
              <input
        ...
        <div class="border-t border-gray-200 pt-6">
          <label for="competences" class="flex cursor-pointer items-start gap-3">
            <input
              id="competences"
              name="competences"
              type="checkbox"
