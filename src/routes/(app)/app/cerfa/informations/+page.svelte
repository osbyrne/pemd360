<script lang="ts">
    ...
    const projectData = $derived(data.list.find(item => item.projetId === projetId) || data.list[0]);
    ...
    function openOperationModal() {
        ...
        operationForm = {
            ...
            dateDebut: projectData?.operationDateDebut ? new Date(projectData.operationDateDebut).toISOString().split('T')[0] : '',
            dateFin: projectData?.operationDateFin ? new Date(projectData.operationDateFin).toISOString().split('T')[0] : '',
            ...
            typologies: [],
            autreType: '',
            datePermis: projectData?.datePermis ? new Date(projectData.datePermis).toISOString().split('T')[0] : '',
            operationsSoumis: [],
            dateRenovation: ''
        };
    ...
    function openDiagnosticModal() {
        diagnosticForm = {
            derniereVisite: projectData?.diagnosticDerniereVisite ? new Date(projectData.diagnosticDerniereVisite).toISOString().split('T')[0] : '',
...
<div class="p-6 max-w-7xl mx-auto">
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-600 mt-2">Informations administratives du projet : Maîtrise d'ouvrage, Opération, Diagnostiqueur</p>
    </div>

    {#if projectData}
        <!-- Project Name Banner -->
        <div class="mb-6 bg-linear-to-r from-emerald-500 to-emerald-600 rounded-xl shadow-lg p-6 text-white">
        ...
        <div class="grid lg:grid-cols-2 gap-6">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl border-2 border-blue-100 shadow-sm overflow-hidden hover:shadow-md transition-shadow">
                    <div class="bg-gradient-to-r from-blue-50 to-blue-100 border-b border-blue-200 px-6 py-4 flex justify-between items-center">
                    ...
                    <div class="p-6">
                        {#if projectData.moaNom || projectData.moaNomPhy}
                            <div class="space-y-3">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1">
                                        <p class="text-xs font-medium text-blue-600 uppercase tracking-wide mb-1">Identité</p>
                                        <p class="font-semibold text-gray-900">{projectData.moaNom || `${projectData.moaPrenomPhy || ''} ${projectData.moaNomPhy || ''}`}</p>
                                    </div>
                                </div>
                                {#if projectData.moaAdresse}
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-xs font-medium text-blue-600 uppercase tracking-wide mb-1">Adresse</p>
                                            <p class="text-gray-900">{projectData.moaAdresse}</p>
                                            <p class="text-sm text-gray-600">{projectData.moaCp || ''} {projectData.moaCommune || ''}</p>
                                        </div>
                                    </div>
                                {/if}
                            </div>
                        {:else}
                            <div class="text-center py-8">
                                ...
                                <p class="text-sm text-gray-500 mt-1">Cliquez sur "Modifier" pour ajouter les informations</p>
                            </div>
                        {/if}
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl border-2 border-purple-100 shadow-sm overflow-hidden hover:shadow-md transition-shadow">
                    <div class="bg-gradient-to-r from-purple-50 to-purple-100 border-b border-purple-200 px-6 py-4 flex justify-between items-center">
                        <div class="flex items-center gap-3">
                        ...
                        {#if projectData.diagnostiqueurNom || projectData.diagnostiqueurNomPhy}
                            <div class="space-y-3">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1">
                                        <p class="text-xs font-medium text-purple-600 uppercase tracking-wide mb-1">Identité</p>
                                        <p class="font-semibold text-gray-900">{projectData.diagnostiqueurNom || `${projectData.diagnostiqueurPrenomPhy || ''} ${projectData.diagnostiqueurNomPhy || ''}`}</p>
                                    </div>
                                </div>
                                {#if projectData.diagnostiqueurAdresse}
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-xs font-medium text-purple-600 uppercase tracking-wide mb-1">Adresse</p>
                                            <p class="text-gray-900">{projectData.diagnostiqueurAdresse}</p>
                                            <p class="text-sm text-gray-600">{projectData.diagnostiqueurCp || ''} {projectData.diagnostiqueurCommune || ''}</p>
                                        </div>
                                    </div>
                                {/if}
                            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl border-2 border-teal-100 shadow-sm overflow-hidden hover:shadow-md transition-shadow">
                    <div class="bg-gradient-to-r from-teal-50 to-teal-100 border-b border-teal-200 px-6 py-4 flex justify-between items-center">
                        <div class="flex items-center gap-3">
                        ...
                        {#if projectData.diagnosticDerniereVisite}
                            <div class="space-y-3">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1">
                                        <p class="text-xs font-medium text-teal-600 uppercase tracking-wide mb-1">Dernière visite</p>
                                        <p class="font-semibold text-gray-900">{new Date(projectData.diagnosticDerniereVisite).toLocaleDateString('fr-FR', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</p>
                                    </div>
                                </div>
                                {#if projectData.diagnosticDesordres !== null}
                                    <div class="grid grid-cols-2 gap-3 mt-4">
                                        <div class="bg-teal-50 rounded-lg p-3">
                                            ...
                                            <p class="text-sm font-semibold text-teal-900">{projectData.diagnosticDesordres ? 'Oui' : 'Non'}</p>
                                        </div>
                                        <div class="bg-teal-50 rounded-lg p-3">
                                            <p class="text-xs text-teal-700 font-medium mb-1">Précautions</p>
                                            <p class="text-sm font-semibold text-teal-900">{projectData.diagnosticPrecaution ? 'Oui' : 'Non'}</p>
                                        </div>
                                    </div>
                                {/if}
                            </div>
                ...
                <!-- Section: L'opération -->
                <div class="bg-white rounded-xl border-2 border-amber-100 shadow-sm overflow-hidden hover:shadow-md transition-shadow">
                    <div class="bg-gradient-to-r from-amber-50 to-amber-100 border-b border-amber-200 px-6 py-4 flex justify-between items-center">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="space-y-4">
                                {#if projectData.operationAdresse}
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-xs font-medium text-amber-600 uppercase tracking-wide mb-1">Localisation</p>
                                            <p class="font-semibold text-gray-900">{projectData.operationAdresse}</p>
                                            <p class="text-sm text-gray-600">{projectData.operationCp || ''} {projectData.operationCommune || ''}</p>
                                        </div>
                                    </div>
                                {/if}
                                {#if projectData.operationType}
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-xs font-medium text-amber-600 uppercase tracking-wide mb-1">Type d'opération</p>
                                ...
                                {#if projectData.datePermis}
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-xs font-medium text-amber-600 uppercase tracking-wide mb-1">Permis de construire</p>
                                            <p class="font-semibold text-gray-900">{new Date(projectData.datePermis).toLocaleDateString('fr-FR')}</p>
                                        </div>
                                    </div>
                                {/if}
                                    ...
                                    <div class="bg-amber-50 rounded-lg p-4 mt-4">
                                        ...
                                        <div class="flex items-center gap-3 text-sm">
                                            {#if projectData.operationDateDebut}
                                                <span class="font-medium text-gray-900">Du {new Date(projectData.operationDateDebut).toLocaleDateString('fr-FR')}</span>
                                            {/if}
                                            {#if projectData.operationDateFin}
                                                <span class="text-gray-600">au {new Date(projectData.operationDateFin).toLocaleDateString('fr-FR')}</span>
                                            {/if}
                                        </div>
                                    </div>
                                {/if}
        ...
        >
            ...
            <div class="p-6 overflow-y-auto max-h-[calc(90vh-140px)]">
                <form class="space-y-6">
                    ...
                    <!-- Type d'opération -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">L'opération est-elle</label>
                        <select 
                    ...
                    <div class="bg-red-50 rounded-lg p-4 space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Nombre de bâtiments concernés</label>
                                <input 
                                    type="number" 
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Surface totale de plancher (m²)</label>
                                <input 
                                    type="number" 
                    ...
                    <!-- Typologies -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Typologies principales des bâtiments</label>
                                    ...
                                    <input 
                                        ...
                                        onchange={(e) => {
                                            if (e.currentTarget.checked) {
                                                ...
                                                operationForm.typologies = operationForm.typologies.filter(t => t !== typologie);
                                            }
                                        }}
                    ...
                    <!-- Date permis -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Date d'obtention du permis de construction du bâtiment le plus ancien</label>
                        <input 
                            type="date" 
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">
                            Cochez, s'il y en a eu, le(s) type(s) d'opération(s) auxquel(s) le bâtiment a été soumis depuis la date mentionnée ci-dessus :
                        </label>
                        <div class="space-y-2">
                            <label class="flex items-center gap-2">
                                <input 
                                    ...
                                    onchange={(e) => {
                                        if (e.currentTarget.checked) {
                                            operationForm.operationsSoumis = [...operationForm.operationsSoumis, 'renovation'];
                                        } else {
                                            operationForm.operationsSoumis = operationForm.operationsSoumis.filter(t => t !== 'renovation');
                                        }
                                    }}
                                    class="rounded border-gray-300 text-amber-600 focus:ring-amber-500"
                                />
                            ...
                            <label class="flex items-center gap-2">
                                <input 
                                    ...
                                    onchange={(e) => {
                                        if (e.currentTarget.checked) {
                                            operationForm.operationsSoumis = [...operationForm.operationsSoumis, 'decontamination'];
                                        } else {
                                            operationForm.operationsSoumis = operationForm.operationsSoumis.filter(t => t !== 'decontamination');
                                        }
                                    }}
                                    class="rounded border-gray-300 text-amber-600 focus:ring-amber-500"
                                />
                                <span class="text-sm text-gray-700">Opération de décontamination (ex: désamiantage)</span>
                            </label>
                            <label class="flex items-center gap-2">
                                <input 
                                    type="checkbox" 
                                    ...
                                    onchange={(e) => {
                                        if (e.currentTarget.checked) {
                                            ...
                                            operationForm.operationsSoumis = operationForm.operationsSoumis.filter(t => t !== 'autre');
                                        }
                                    }}
                                    class="rounded border-gray-300 text-amber-600 focus:ring-amber-500"
                                />
                            ...
                            <label class="flex items-center gap-2">
                                <input 
                                    ...
                                    onchange={(e) => {
                                        if (e.currentTarget.checked) {
                                            operationForm.operationsSoumis = [...operationForm.operationsSoumis, 'aucune'];
                                        } else {
                                            operationForm.operationsSoumis = operationForm.operationsSoumis.filter(t => t !== 'aucune');
                                        }
                                    }}
                                    class="rounded border-gray-300 text-amber-600 focus:ring-amber-500"
                                />
                            ...
                            <label class="flex items-center gap-2">
                                <input 
                                    ...
                                    onchange={(e) => {
                                        if (e.currentTarget.checked) {
                                            operationForm.operationsSoumis = [...operationForm.operationsSoumis, 'ne_sait_pas'];
                                        } else {
                                            operationForm.operationsSoumis = operationForm.operationsSoumis.filter(t => t !== 'ne_sait_pas');
                                        }
                                    }}
                                    class="rounded border-gray-300 text-amber-600 focus:ring-amber-500"
                                />
                ...
                <form class="space-y-6">
                    ...
                    {:else}
                        ...
                        <div class="bg-blue-50 rounded-lg p-4 space-y-4">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Numéro de Siret ou Siren</label>
                                <input 
                                    type="text" 
                ...
                <form class="space-y-6">
                    ...
                    <div class="border-t border-gray-200 pt-6 space-y-4">
                        ...
                        <label class="flex items-start gap-3 cursor-pointer">
                            ...
                            <span class="text-sm text-gray-700">
                                Je déclare qu'en cas de sinistre l'assurance souscrite couvre les activités du diagnostiqueur et que le montant de la garantie est d'au moins 300 000 € par sinistre et 500 000 € par année d'assurance.
                            </span>
                        </label>

                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Nom de la compagnie d'assurance</label>
                            <input 
                                type="text" 
                    ...
                    <div class="border-t border-gray-200 pt-6">
                        <label class="flex items-start gap-3 cursor-pointer">
                            ...
                            />
                            <span class="text-sm text-gray-700">
                                Je déclare pouvoir justifier des compétences du diagnostiqueur à la demande de l'administration. (3)
                            </span>
                        </label>
                    </div>
                </form>
        ...
        >
            ...
            <div class="p-6 overflow-y-auto max-h-[calc(90vh-140px)]">
                <form class="space-y-6">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Date de la dernière visite de l'opération</label>
                        <input 
                            type="date" 
                    ...
                    <!-- Bâtiments visitées -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Les bâtiments ou parties de bâtiments visitées par le diagnostiqueur</label>
                        <textarea 
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Les bâtiments ou parties de bâtiments non visitées par le diagnostiqueur</label>
                        <textarea 
                    ...
                    <!-- Raisons -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Raisons pour n'avoir pas visité ces parties</label>
                        <textarea 
                    ...
                    <!-- Vices ou désordres -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Le diagnostic a-t-il identifié des vices ou des désordres apparents dans des composants des bâtiments ?</label>
                    ...
                    <!-- Précautions -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Le rapport de diagnostic fournit-il des indications sur les précautions de démolition ou de rénovation ?</label>
                        <div class="flex gap-4">
                            <label class="flex items-center gap-2 cursor-pointer">
                                <input 
                                    type="radio" 
                            ...
                            {#each ['Dossier des Ouvrages Exécutés (DOE) des bâtiments existants', 'Plans', 'Diagnostic amiante', 'Diagnostic plomb', 'Diagnostic termites', 'Autre'] as doc}
                                <label class="flex items-center gap-2">
                                    <input 
                                        ...
                                        onchange={(e) => {
                                            if (e.currentTarget.checked) {
                                                diagnosticForm.documentsConsultes = [...diagnosticForm.documentsConsultes, doc];
                                            } else {
                                                diagnosticForm.documentsConsultes = diagnosticForm.documentsConsultes.filter(d => d !== doc);
                                            }
                                        }}
