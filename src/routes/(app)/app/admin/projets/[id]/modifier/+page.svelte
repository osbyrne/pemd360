<script lang="ts">
	...
	$: data_form = form?.data || {
		...
		idEtabId: projet.idEtabId?.toString() || '',
...
<div class="font-[Poppins] max-w-4xl mx-auto px-4 py-8">
	...
	<div class="mb-8">
		...
		<p class="text-sm text-gray-500">{projet.reference} - {projet.libelle}</p>
	</div>
		...
		<div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
			...
			<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
				<div class="space-y-1.5 md:col-span-2">
					...
					/>
					<p class="text-xs text-gray-500 mt-1">L'ID Matterport ne peut pas être modifié (clé primaire)</p>
				</div>
