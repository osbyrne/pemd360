			...
			<div class="overflow-y-auto p-6">
				...
				>
					...
					<div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
						...
						<div>
							<label for="codeDechet" class="block text-sm font-medium text-gray-700 mb-1">Code Déchet</label>
							<input
								id="codeDechet"
								type="number"
								name="codeDechet"
						...
						<div>
							<label for="densite" class="block text-sm font-medium text-gray-700 mb-1">Densité</label>
							<input
								id="densite"
								type="number"
								step="0.01"
						...
						<div>
							<label for="stockage" class="block text-sm font-medium text-gray-700 mb-1">Stockage</label>
							<input
								id="stockage"
								type="text"
								name="stockage"
						...
						<div>
							<label for="ecoOrganismeRep" class="block text-sm font-medium text-gray-700 mb-1">Eco Organisme REP</label>
							<input
								id="ecoOrganismeRep"
								type="text"
