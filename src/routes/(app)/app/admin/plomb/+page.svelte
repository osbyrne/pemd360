			...
			<table class="w-full text-left text-sm text-gray-600">
				<thead class="bg-gray-50 text-xs uppercase font-semibold text-gray-500 border-b border-gray-200">
					<tr>
						...
						<th class="px-6 py-4">Présence</th>
                        <th class="px-6 py-4">Concentration</th>
					...
					{:else}
						{#each displayedList as item}
							<tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    {#if item.presencePlomb}
                                        <span class="text-red-600 font-medium">Oui</span>
                                    {:else}
                                        <span class="text-green-600">Non</span>
                                    {/if}
                                </td>
                                <td class="px-6 py-4 font-mono">{item.concentration || '-'}</td>
								<td class="px-6 py-4">
