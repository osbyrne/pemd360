					...
					{:else}
						{#each displayedList as item}
							<tr class="hover:bg-gray-50 transition-colors">
								...
								<td class="px-6 py-4"> Termites </td>
								<td class="px-6 py-4">
									{#if item.customImage}
										<img
		...
		>
			<div class="flex flex-col items-center text-center">
				...
				<p class="text-sm text-gray-500 mb-6">
					Êtes-vous sûr de vouloir supprimer ce tag <span class="font-medium text-gray-900"
