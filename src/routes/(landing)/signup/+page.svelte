...
<div
    class="flex min-h-screen items-center justify-center bg-linear-to-br from-emerald-50 via-white to-emerald-50 px-4 py-12"
>
    <div class="w-full max-w-md">
        ...
        <div class="rounded-2xl p-8 shadow-xl">
            ...
            >
                            ...
                            <div class="flex gap-1">
                                {#each Array(3) as _, i}
                                    <div class="h-1 flex-1 rounded-full">
                                        <div
                                            class="h-full rounded-full transition-all {i <
                ...
                <button
                    type="submit"
                    class="flex w-full items-center justify-center gap-2 rounded-lg bg-emerald-600 px-4 py-3 font-semibold text-white transition-all hover:bg-emerald-700 focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed disabled:opacity-60"
                    disabled={loading}
                >
                    {#if loading}
        ...
        <!-- Footer -->
        <div class="mt-8 text-center">
            <a href="/" class="text-sm hover:text-emerald-600"
                >Retour à l'accueil
            </a>
        </div>
    </div>
