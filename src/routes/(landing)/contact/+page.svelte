...
<section class="py-16 lg:py-24">
  <div class="container mx-auto px-4">
    <div class="grid gap-12 lg:grid-cols-1">
      ...
      <div>
        <span
          class="mb-2 inline-block text-sm font-semibold tracking-wider text-emerald-600 uppercase"
        >
          Contactez-nous
        </span>
        ...
        <div class="space-y-6">
          {#each contactInfo as info}
            <a
              ...
              class="hover: flex items-start gap-4 rounded-lg p-4 transition-colors"
            >
              <div
